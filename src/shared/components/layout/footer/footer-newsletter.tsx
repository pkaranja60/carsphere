    ...
    <div className="flex flex-col gap-space-md lg:col-span-1">
      ...
      <div className="pt-space-xs">
        ...
        <div className="flex flex-col gap-2">
          <input
            className="h-10 w-full rounded-lg border border-[#D1CEC7] bg-white px-space-md font-body-sm text-body-sm text-on-surface placeholder:text-outline focus:border-primary-container focus:outline-none"
