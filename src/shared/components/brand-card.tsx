...
export function BrandCard({
  ...
  return (
    <Link
      className={`group flex h-24 items-center justify-center rounded-xl border border-border bg-surface-alt transition hover:border-primary hover:shadow-md ${containerClassName}`}
      href={href}
    >
      {children ? (
        children
